...
public class BrewiseCoffeeShop {
    ...
    static void mainMenu() {
        while (true) {
            System.out.println("\n" + ColorConstants.MENU_BOX_BG + "╔═══════════════════════════════════════════════════════════╗" + ColorConstants.RESET);
            System.out.println(ColorConstants.MENU_BOX_BG + "║" + ColorConstants.HEADER + "                   MAIN MENU                               " + ColorConstants.RESET + ColorConstants.MENU_BOX_BG + "║" + ColorConstants.RESET);
            System.out.println(ColorConstants.MENU_BOX_BG + "╠═══════════════════════════════════════════════════════════╣" + ColorConstants.RESET);
            System.out.println(ColorConstants.MENU_BOX_BG + "║                                                           ║" + ColorConstants.RESET);
            System.out.println(ColorConstants.MENU_BOX_BG + "║" + ColorConstants.RESET + ColorConstants.MENU_BOX_BG + "    " + ColorConstants.MENU_ITEM + "[1]  Browse Menu" + ColorConstants.RESET + ColorConstants.MENU_BOX_BG + "                                       ║" + ColorConstants.RESET);
            System.out.println(ColorConstants.MENU_BOX_BG + "║" + ColorConstants.RESET + ColorConstants.MENU_BOX_BG + "    " + ColorConstants.MENU_ITEM + "[2]  View/Edit Basket" + ColorConstants.RESET + ColorConstants.MENU_BOX_BG + "                                  ║" + ColorConstants.RESET);
            System.out.println(ColorConstants.MENU_BOX_BG + "║" + ColorConstants.RESET + ColorConstants.MENU_BOX_BG + "    " + ColorConstants.MENU_ITEM + "[3]  Checkout & Payment" + ColorConstants.RESET + ColorConstants.MENU_BOX_BG + "                                ║" + ColorConstants.RESET);
            System.out.println(ColorConstants.MENU_BOX_BG + "║" + ColorConstants.RESET + ColorConstants.MENU_BOX_BG + "    " + ColorConstants.MENU_ITEM + "[4]  Quick Stats" + ColorConstants.RESET + ColorConstants.MENU_BOX_BG + "                                       ║" + ColorConstants.RESET);
            System.out.println(ColorConstants.MENU_BOX_BG + "║" + ColorConstants.RESET + ColorConstants.MENU_BOX_BG + "    " + ColorConstants.WARNING + "[5]  Exit" + ColorConstants.RESET + ColorConstants.MENU_BOX_BG + "                                              ║" + ColorConstants.RESET);
            System.out.println(ColorConstants.MENU_BOX_BG + "║                                                           ║" + ColorConstants.RESET);
            System.out.println(ColorConstants.MENU_BOX_BG + "╚═══════════════════════════════════════════════════════════╝" + ColorConstants.RESET);
